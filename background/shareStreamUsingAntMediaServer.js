function shareStreamUsingAntMediaServer(stream) {
  ...
  wrapper.callbacks("onopen", function() {
    ...
    wrapper.publish(stream, uid, function(isPublished, error) {
      if (isPublished === true) {
        ...
        var html =
          "<title>Unique Room URL</title><link rel='icon' href='images/icon_128.png'><h1 style='text-align:center'>Copy following private URL:</h1>";
        html +=
          "<p><label style='font-weight:bold'>WebRTC URL:</label><br><input type='text' value='" +
          resultingURL +
          "' style='text-align:left;width:100%;font-size:1.2em;'></p>";
        html +=
          "<p><label style='font-weight:bold'>HLS Live Stream URL:</label><br><input type='text' value='" +
          hlsURL +
          "' style='text-align:left;width:100%;font-size:1.2em;'></p>";
  ...
  wrapper.callbacks("onerror", function() {
    alert(
      "Ant-Media Server is down or not reachable in the moment. Please go to options page and try other streaming method."
    );
